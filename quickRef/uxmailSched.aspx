<%@ Page Title="UXMail Schedule Override | Communications Technologies Inc."
    Language="C#" MasterPageFile="~/masterpage.master" %>


<asp:Content ID="content" ContentPlaceHolderID="cphMain" runat="Server">
    <h1>
        UXMail, Aspiremail, NVM and Vangard Series Schedule Override</h1>
    <p>
        ...
        greeting to play temporarily, you must follow the steps listed below.</p>
    <h4>
        Activate:</h4>
    <ol>
        ...
        <li>Press 99 to disconnect from voice mail system.</li></ol>
    <h4>
        Deactivate:</h4>
    <ol>
